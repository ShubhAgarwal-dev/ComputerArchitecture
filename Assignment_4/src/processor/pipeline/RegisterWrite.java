        ...
        if (MA_RW_Latch.isRW_enable()) {
            ...
            if (opCode != 30) {
                ...
                if (opCode >= 0 && opCode <= 21) {
                    ...
                    // System.out.println("[Debug] (RW) Write to register " + rd + " data " +
                    // opResult);
                ...
                if (opCode == 22) {
                    ...
                    // System.out.println("[Debug] (RW) Write register " + rd + " to " +
                    // loadResult);
                ...
                if (opCode >= 0 && opCode <= 21 && MA_RW_Latch.getR31() != -1) {
                    ...
                    // System.out.println("[Debug] (RW) Write to register 31 data " +
                    // MA_RW_Latch.getR31());
                }
